...
def manually_fill():
    ...
    sb.title("Enter Designation name...")
    sb.geometry('580x320')
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            STU_NAME = tk.Label(MFW, text="Enter your name", width=15, height=2, fg="black", bg="grey",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/ASUS/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\ASUS\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    SUB = tk.Label(sb, text="Enter Designation : ", width=15, height=2,
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(
                'C:\\Users\\ASUS\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site-packages\\cv2\\data\\haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
            ...
            with open(r'C:\Users\ASUS\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/ASUS/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/' + fileName
    ...
    windo.title("Enter Designation name...")
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\ASUS\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets", command=Attf, fg="white", bg="black",
                     width=12, height=1, activebackground="white", font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Enter Designation : ", width=15, height=2,
    ...
    def log_in():
        ...
        if username == 'Admin':
            if password == 'Admin123':
                ...
                cs = r'C:\Users\ASUS\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
AP = tk.Button(window, text="Check Registered User", command=admin_panel, fg="black",
...
quitWindow = tk.Button(window, text="Quit", command=quit, fg="black", bg="SkyBlue1",
                       width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
quitWindow.place(x=550, y=600)
